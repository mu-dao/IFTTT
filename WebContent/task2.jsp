...
<%//读取数据库中的内容，创建任务的相应数组 ,学习如何把任务信息放在select框中
	  ...
	  String sql = "SELECT * FROM TASK WHERE Uname="+"'"+name+"'";
...
<form method="post" name="taskForm" action="TaskServlet">
	...
	<div id="div_b0">
		...
		<div style=float:left id="div_b2">
			<input type="submit" id="b_start" value="START" name="start" >
		</div>

		<div style=float:left id="div_b3">
			<input type="submit" id="b_stop" value="STOP"  name="stop">
		</div>

		<div style=float:left id="div_b4">
			<input type="submit" id="b_alter" value="MODIFY" name="alter">
		</div>
