...
public class Task extends Thread{
	...
	private String Send_Mail;					 //发邮件的Gmail
	String Mail_User;							 //邮件授权的账号
	private String Send_PW;						 //发邮件的Gmail的密码
	...
	//转换时间日期格式
		public static Date StringToDate(String day,String time){//day 指的是date，包含年月日
			Date date=new Date();
	...
	public boolean waitweibo() throws InterruptedException{    //一段时间不发微博判断
		wait_is_over= 0;
		myttask = new myTTask();
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException, InterruptedException{
		Thread B = new Thread(new Task("GD",1,1,2,1,"2015-12-25","17:47:50","669279048@qq.com","huanga9526,","listen Weibo","listen Password","listen","weibo account","seibo password","wb","669279048@qq.com","669279048","huanga9526,","liwenamo1@163.com","HAHAHAH","1","2.00X1jziF0WbfZTba0b8c1c0bxj179C"));
		B.start();
	}
	*/
